...
$ `git lfs clone https://github.com/PM-Exaleap01/Exaleap-Semi-_Boot-Image-FU540.git`

3, Untar the file

$ `cd Exaleap-Semi-_Boot-Image-FU540 && tar -xvf core-image-base.exaleapsemi.tar.gz`
